    ...
    <div id="outer">
        ...
        <div id="enroll-area"> 
	        ...
	        <form action="<%=contextPath%>/update.co" method="post" id="enroll-form">
	        	...
	        	<input type="hidden" name="num" value="<%= company.getCompanyNo() %>">
	
	            <table>
	                <tr>
	                    <th width="100"><h4>게임사</h4></th>
	                    <td><input type="text" name="companyName" required value="<%=company.getCompanyName()%>"></td>
	                </tr>
	                <tr><td colspan=2 height="30"></td></tr>
	                <tr>
	                    <th><h4>아이디</h4></th>
	                    <td><input type="text" name="companyId" required value="<%=company.getCompanyId()%>"></td>
	                </tr>
	                <tr><td colspan=2 height="30"></td></tr>
	                <tr>
	                    <th><h4>등록코드</h4></th>
	                    <td><%=company.getCompanyPwd()%></td>
	                </tr>
	                <tr><td colspan=2 height="30"></td></tr>
	                <tr>
	                    <th><h4>대표자</h4></th>
	                    <td><input type="text" name="companyHead" required value="<%=company.getCompanyHead()%>"></td>
	                </tr>
	                <tr><td colspan=2 height="30"></td></tr>
	                <tr>
	                    ...
	                    <td>
	                    	<% if(company.getCompanyComment() != null) { %>
	                    		<textarea name="comment" cols="79" rows="5" style="resize:none"><%=company.getCompanyComment()%></textarea>
	                   		<% }else { %>
